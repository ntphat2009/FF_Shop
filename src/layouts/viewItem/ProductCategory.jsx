...
const ProductCategory = () => {
	...
	useEffect(() => {
		const fetchProduct = async () => {
			try {
				const response = await axios.get(`https://localhost:44389/api/Products/category/${cateId}`);
							...
							<div class="card mb-3">
								<div class="card-body">
									<ol class="breadcrumb float-left">
										...
										<li class="breadcrumb-item"><a href="#" className='text-default'>{product[0].CategoryName}</a></li>
								...
								<header class="mb-3">
									<div class="form-inline">
										<strong class="mr-md-auto">
											{product.length} Sản phẩm tìm thấy
										</strong>
