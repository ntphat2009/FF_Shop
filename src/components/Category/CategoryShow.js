...
const CategoryShow = () => {
  ...
  const handleTrashClick = async (categoryId) => {
    try {
      const categoryResponse = await axios.get(`https://localhost:44389/api/Category/${categoryId}`);

      const category = categoryResponse.data;
      category.Status = false;
      console.log(category)
      const updateResponse = await fetch(
        `https://localhost:44389/api/Category/${categoryId}`,
        {
          method:'PUT',
      ...
      <div className="container-fluid">
        <div className="row mb-2">
          <div className="col-sm-6">
            <h2>Chi tiết danh mục [Category]</h2>
          </div>
          <div className="col-sm-6">
            <ol className="breadcrumb float-sm-right">
              <li className="breadcrumb-item">
                <Link className="btn btn-success" to={`../admin/category`}>
                  Quay về danh mục
                </Link>
              </li>
            </ol>
          ...
          <div className="card-body">
            <div className="row">
              <div className="col-12 col-sm-6">
                ...
                <div className="col-12 Category-image-thumbs">
                  <div className="Category-image-thumb active">
                  <img
              ...
              <div className="col-12 col-sm-6">
                <h3 className="my-3">Tên danh mục</h3>
                <p>{product.Name}</p>
                <hr />
                <h5>Description</h5>
                ...
                {/* <div className="mt-4 Category-share">
            ...
            {/* <div className="row mt-4">
              <nav className="w-100">
                <div className="nav nav-tabs" id="Category-tab" role="tablist">
                  <a
