  ...
  const handleTrashClick = async (postId) => {
    try {
      ...
      const updateResponse = await axios.put(
        `https://localhost:44389/api/Post/update-post?${postId}`,post,
        {
      ...
      <div className="container-fluid">
        <div className="row mb-2">
          <div className="col-sm-6">
            <h2>Chi tiết chủ đề [Post]</h2>
          </div>
          <div className="col-sm-6">
            <ol className="breadcrumb float-sm-right">
              <li className="breadcrumb-item">
                <Link className="btn btn-success" to={`../admin/post`}>
                  Quay về 
                </Link>
              </li>
            </ol>
          ...
          <div className="card-body">
            <div className="row">
              <div className="col-12 col-sm-6">
                ...
                <div className="col-12 Post-image-thumbs">
                  <div className="Post-image-thumb active">
            ...
            {/* <div className="row mt-4">
              <nav className="w-100">
                <div className="nav nav-tabs" id="Post-tab" role="tablist">
                  <a
              ...
              <div className="tab-content p-3" id="nav-tabContent">
                ...
                <div
                  ...
                  id="Post-comments"
                  role="tabpanel"
                  aria-labelledby="Post-comments-tab"
                >
                  {" "}
                ...
                <div
                  ...
                  id="Post-rating"
                  role="tabpanel"
                  aria-labelledby="Post-rating-tab"
                >
                  {" "}
