      ...
      <div className="container-fluid">
        <div className="row mb-2">
          <div className="col-sm-6">
            <h2>Chi tiết chủ đề [Tag]</h2>
          </div>
          <div className="col-sm-6">
            <ol className="breadcrumb float-sm-right">
              <li className="breadcrumb-item">
                <Link className="btn btn-success" to={`../admin/tag`}>
                  Quay về 
                </Link>
              </li>
            </ol>
          ...
          <div className="card-body">
            <div className="row">
              <div className="col-12 col-sm-6">
                ...
                <div className="col-12 Tag-image-thumbs">
                  <div className="Tag-image-thumb active">
            ...
            {/* <div className="row mt-4">
              <nav className="w-100">
                <div className="nav nav-tabs" id="Tag-tab" role="tablist">
                  <a
              ...
              <div className="tab-content p-3" id="nav-tabContent">
                ...
                <div
                  ...
                  id="Tag-comments"
                  role="tabpanel"
                  aria-labelledby="Tag-comments-tab"
                >
                  {" "}
                ...
                <div
                  ...
                  id="Tag-rating"
                  role="tabpanel"
                  aria-labelledby="Tag-rating-tab"
                >
                  {" "}
